...
%%%%%%%%% ABSTRACT
\begin{abstract}
    The detection of strong gravitational lenses
\end{abstract}
...
we will code our own convolutional net in python using \textsc{theano}. Second,
we will apply transfer learning techniques to train on a convolutional net
...
enumerated morphologies. We plan to train our classifier on top of the first
